        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            @if (session('temp_password'))
                <div class="mb-4 px-4 py-4 bg-yellow-50 border border-yellow-300 text-yellow-900 rounded">
                    ...
                    <p>{{ __('wms.users.temp_password_notice', ['name' => session('temp_user'), 'password' => session('temp_password')]) }}</p>
                    ...
                    @else
                        <table class="min-w-full divide-y divide-gray-200 text-sm">
                            <thead class="bg-gray-50">
                                <tr>
                                    <th class="px-4 py-3 text-left font-medium text-gray-600">{{ __('wms.users.name') }}</th>
                                    <th class="px-4 py-3 text-left font-medium text-gray-600">{{ __('wms.users.email') }}</th>
                                    <th class="px-4 py-3 text-left font-medium text-gray-600">{{ __('wms.users.role') }}</th>
                                    <th class="px-4 py-3 text-left font-medium text-gray-600">{{ __('wms.users.status') }}</th>
