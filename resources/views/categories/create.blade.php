<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-gray-800 leading-tight">{{ __('wms.categories.create') }}</h2>
    </x-slot>
        ...
        <div class="max-w-2xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm rounded-lg p-6">
                <form action="{{ route('categories.store') }}" method="POST" class="space-y-4">
                    ...
                    <div>
                        <label
                            class="block text-sm font-medium text-gray-700">{{ __('wms.categories.description') }}</label>
